...
def convert_coordinate(coordenada):
    ...
    """
    coordenada_separada = coordenada[0]
    coordenada_dos= coordenada[1]

    coordenada_ff= tuple(coordenada_separada + coordenada_dos)
    return coordenada_ff
...
def create_record(registro_azara, registro_rui):
    ...
    """
    registroa= get_coordinate(registro_azara)
    registro_corregido= convert_coordinate(registroa)
    if registro_corregido == registro_rui[1]:
        nuevo_registro= registro_azara + registro_rui
